...
Namespace MODELNAMESPACE.Base
    ...
    Public Partial Interface IBaseModel
        ...
        Sub SetValues(row As DataRow, propertyPrefix as String)
    End Interface
    ...
    Public MustInherit Partial Class BaseModel
        ...
        Public MustOverride Sub SetValues(row As DataRow, propertyPrefix as String) Implements IBaseModel.SetValues
