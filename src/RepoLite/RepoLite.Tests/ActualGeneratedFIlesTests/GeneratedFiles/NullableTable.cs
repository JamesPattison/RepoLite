...
namespace NS
{
    public partial interface INullableTableRepository : IBaseRepository<NullableTable>
    {
        ...
        bool Delete(NullableTable item);
    ...
    public sealed partial class NullableTableRepository : BaseRepository<NullableTable>, INullableTableRepository
    {
            ...
            "dbo", "NullableTable", 4)
        {
            ...
            Columns.Add(new ColumnDefinition("Age", "[INT]", true, false, false));
            Columns.Add(new ColumnDefinition("DoB", "[DATETIME]", true, false, false));
            Columns.Add(new ColumnDefinition("lolVal", "[UNIQUEIDENTIFIER]", true, false, false));
        }
        ...
        public bool Delete(NullableTable nullableTable)
        {
            ...
            deleteTable.AddColumn("Id", nullableTable.Id);
